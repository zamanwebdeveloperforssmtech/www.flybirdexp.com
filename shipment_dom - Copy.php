...
<body background="images/hole.jpg" bottom  leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<table width="45%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td width="34%"><div align="left"><a href ="domestic_tracking.php"><h2>Back</h2></a></div><div align="right"><br><h2>Track Another : </h2></div></td>
