...
$sql = "Select * from employee where user_id = '$user_id' and user_type = '$user_type'";
...
<form name="employeeadd" enctype="multipart/form-data" method="post" action="modiysucemployee.php" target="mainFrame" >
<input type="hidden" name="emp_id" id="emp_id" value="<?php echo $user_id;?>">
  <table width="85%" height="447" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#F2F2F2">
          <tr bgcolor="#E4E4E4"> 
            <td height="23" colspan="3" background="item/titl.jpg"><div align="center" class="brandColorEmph">Edit 
          ...
          <tr> 
            ...
            <td width="263"> <input name="employeename" type="text" size="32" value="<?php echo $row[1];?>" /></td>
          </tr>
          <tr> 
            <td><div align="center"><strong>Present Address </strong></div></td>
            <td><div align="center"><strong>:</strong></div></td>
            <td><textarea name="preadress" rows="2" cols="25"><?php echo $row[3];?></textarea> </td>
          </tr>
          <tr> 
            <td><div align="center"><strong>Permanent Address</strong></div></td>
            <td><div align="center"><strong>:</strong></div></td>
            <td><textarea name="peraddress" rows="2" cols="25"><?php echo $row[4];?></textarea></td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td><div align="center"><strong>:</strong></div></td>
            <td><input type="text" name="dateofbirth" size="32" value="<?php echo $row[5];?>"> <A id=anchor19 title="cal19.select(document.forms[0].dateofbirth,'anchor19','yyyy-MM-dd'); return false;" 
          ...
          <tr> 
            ...
            <td><div align="center"><strong>:</strong></div></td>
            <td><input type="text" name="contactno" size="32" value="<?php echo $row[6];?>" /></td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td><div align="center"><strong>:</strong></div></td>
            <td><input type="text" name="bloodgroup" size="32" value="<?php echo $row[7];?>"></td>
          </tr>
          <tr> 
            <td><div align="center"><strong>E-mail Address </strong></div></td>
            <td><div align="center"><strong>:</strong></div></td>
            <td><input name="emailaddress" type="text" size="32" value="<?php echo $row[8];?>" /></td>
          </tr>
          <tr> 
