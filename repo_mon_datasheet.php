...
<body>
<form id="monthrepo" name="monthrepo" method="post" action="report_monthly_datasheet.php" onsubmit='return formValidator()' target="_blank">
  
     <table width="76%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#F7F7F7" bgcolor="#F0F0F0">
          <tr> 
            
            <td height="34" colspan="3" align="center" valign="middle" background="item/List.gif"><div align="center"><font color="#330099" size="-1" face="Courier New, Courier, mono">Search 
            Data Sheet</font></div></td>
          </tr>
          <tr> 
