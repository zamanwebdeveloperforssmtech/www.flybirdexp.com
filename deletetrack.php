...
session_start();
include('db_conn.php');
$hawb_no = isset($_REQUEST['track_no']) ? $_REQUEST['track_no'] : '';
?>
<html>
<title></title>
...
<form name="deltrac"  method="post" target="mainFrame">
    <table width="90%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FCFCFC" align="center">
      <tr align="left" bgcolor="#6600FF"> 
        <th width="15%" style="color: #FFFFFF" >HAWB</th>
        <th width="29%" style="color: #FFFFFF" >Date &amp; Time</th>
        <th width="29%" style="color: #FFFFFF" >Origin</th>
        <th width="22%" style="color: #FFFFFF" >Destination</th>
