...
<head>
<title>Welcome to Visit Bengal Express</title>
...
<!--
  ...
  location.href="domestic_tracking.php?h="+myHeight;
-->
</script>
<?php
	}
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
    <TBODY>
      ...
      src="item/home-nav.gif" width=608 align=top border=0></TD>
        <form name="the_form" id="the_form" method="post" action="domestic_tracking.php">
          <TD width=26 
                  ...
                  <tr> 
                    ...
                    <td width="591"><div align="center"> 
                        <table width="575" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr> 
                            <td height="39" colspan="3" class="tabfontfocus"><div align="center" class="eprofitsRboxTitleDiv"><strong>Domestic</strong></div></td>
                          </tr>
                          <tr> 
                            <td height="7" colspan="3" class="tabfontfocus">&nbsp;</td>
                          </tr>
                          <tr> 
                            <td width="241" height="16" class="tabfontfocus"><div align="justify" class="tabfontfocus"><u><b>Shipment 
                                Tracker:</b></u></div></td>
                            ...
                            <td height="113" colspan="3" class="tabfontfocus"><table width="431" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td width="431" height="113"><div align="justify"> 
                                      <span class="tabfontfocus"><strong>Please 
                                      track status of your shipment(s) with our 
                                      Airwaybill Nos. (<span class="style1">each 
                                      tracking no in one line</span>) </strong></span><font face="tahoma" color="navy" size="2"> 
                          ...
                          <tr> 
                            <td height="14" colspan="3" class="tabfontfocus"><div align="justify"></div></td>
                          </tr>
                          <tr> 
                            <td height="14" colspan="3" class="tabfontfocus">&nbsp;</td>
                          </tr>
                        </table>
                      </div></td>
                  </tr>
