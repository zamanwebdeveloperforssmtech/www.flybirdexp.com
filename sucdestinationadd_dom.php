...
$others=$_REQUEST['others'];
			 ...
			 $qry="INSERT INTO destination_dom(`agent_id`,`sen_acc_no`,  `origin`, `destination`, `sender_name`, `phone`, `company`, `address`,
			  ...
			  `unit_measure`, `weight`, `unit_value`, `total_value`, `others`) VALUES
				...
				if(mysql_query($qry) or die(mysql_error()))
				{
					...
					echo "<script> window.location='destination_dom.php'; </script>";
				}
				else 
				{
