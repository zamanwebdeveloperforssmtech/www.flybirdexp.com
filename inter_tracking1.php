...
<body style="background-color:#003300" alink="#0099FF" vlink="#0099FF" link="#07568F">
<table width="1299">
   ...
   <TR>
	 ...
	 <table width="635">
	   <tr><td width="408" height="149"><div align="right"><br>
		 ...
		 <br>
		 <br>
	     <em><strong>Chech your tracking number</strong></em></span></div>
	  ...
	  <tr>
	    <td height="234" align="center"><table width="804">
	      ...
	      <table width="100%" cellspacing="2" cellpadding="2">
		    ...
		    <tr> 
                            <td height="14" colspan="3"><font color="#000000" size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>Tracking</strong></font></td>
                          </tr>
                          <tr> 
                            <td colspan="3"><hr></td>
                          </tr>
                          <tr> 
                            <td height="39" colspan="3" class="tabfontfocus"><div align="center" class="eprofitsRboxTitleDiv"><strong>International</strong></div></td>
                          </tr>
                          <tr> 
                            <td height="7" colspan="3" class="tabfontfocus">&nbsp;</td>
                          </tr>
                          <tr> 
                            <td width="241" height="16" class="tabfontfocus"><div align="justify" class="alert"><u><b>Shipment 
                                Tracker:</b></u></div></td>
                            <td width="19" class="tabfontfocus">&nbsp;</td>
                            <td width="255" class="tabfontfocus"><div align="justify"></div></td>
                          </tr>
                          <tr> 
                            <td height="113" colspan="3" class="tabfontfocus"><table width="431" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td width="431" height="113"><div align="justify"> 
                                      <font size="-1"><span class="alert"><strong>Please 
                                      track status of your shipment(s) with our 
                                      Airwaybill Nos. (each tracking no in one 
                                      line) </strong></span></font><font face="tahoma" color="navy" size="2">
<form action="shipment.php" method="post" target="window.open('shipment.php','Tracking Info','status=1,toolbar=1,location=no')">
                                        <p> 
                                          <textarea name="track_no" cols="20" rows="5"></textarea>
  ...
  <tr>
	...
	<table bgcolor="#006666"><tr bgcolor="" align="center">
	  <td width="800" height="21"><div><span class="style28 style6 style9 style10"><span class="style28 style15 style12">Privacy Statement l Legal Notice </span></span></div></td>
	</tr></table>	</td>
  </tr>
   <tr>
    <td width="100%" style="BORDER-RIGHT: #111111; BORDER-TOP: medium none; BORDER-LEFT: #111111; BORDER-BOTTOM: medium none" height="3">	</td>
  </tr>
   <tr>
    <td width="100%" style="BORDER-RIGHT: #111111; BORDER-TOP: medium none; BORDER-LEFT: #111111; BORDER-BOTTOM: medium none" height="16">
