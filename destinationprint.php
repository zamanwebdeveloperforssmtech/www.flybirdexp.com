...
<form name="form1" action="" method="post">
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
            <td width="60%"><font size="2" face="Arial, Helvetica, sans-serif"><img src="images/banaer.jpg" width="700" ></font></td>
             <td width="200" class="bill"><div style="font-size:30px;width:200px;">AIR WAYBILL</div><br/>
              <?php
  ...
  <table width="800" border="0" cellspacing="5" cellpadding="5" >
    ...
    <tr> 
      <td width="400" valign="top" class="fdiv">
      
      <table border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF"  bordercolordark="#DFFECB" class="tablehide">
          ...
          <tr> 
            <td  colspan="2" valign="top"><font size="2" face="Arial, Helvetica, sans-serif">Sender's Account Number <br>
              <input name="acc_no" type="text" id="acc_no" size="30" value="<?php echo $myrow['sen_acc_no'];?>">
              </font></td>
            <td  valign="top"><font size="2" face="Arial, Helvetica, sans-serif">Origin <br>
              <input name="origin" type="text" id="origin" value="<?php echo $myrow['origin'];?>">
              </font></td>
            <td  valign="top"><font size="2" face="Arial, Helvetica, sans-serif">Destination <br>
          ...
          <tr> 
            <td colspan="2" valign="top"><font size="2" face="Arial, Helvetica, sans-serif">Sender's 
              Name<br>
              <input name="sen_name" type="text" id="sen_name" size="30" value="<?php echo $myrow['sender_name'];?>">
              </font></td>
            <td  valign="top"><font size="2" face="Arial, Helvetica, sans-serif">Phone 
              <br>
              <input name="phone" type="text" id="phone" size="20" value="<?php echo $myrow['phone'];?>">
              </font></td>
              <td  valign="top"><font size="2" face="Arial, Helvetica, sans-serif">Phone 
              <br>
          ...
          <tr> 
            <td height="31" align="left" valign="top" colspan="4"><font size="2" face="Arial, Helvetica, sans-serif">Company&nbsp;&nbsp;<input name="company" type="text" id="company" size="60" value="<?php echo $myrow['company'];?>">
            </font></td>
          </tr>
          <tr> 
         ...
         <tr> 
          ...
          <tr> 
			...
			<font size="2" face="Arial, Helvetica, sans-serif">Company&nbsp;&nbsp;<input name="rece_company" type="text" id="rece_company" size="41" value="<?php echo $myrow['rece_company'];?>"></font></td>
         ...
         <tr> 
		  ...
		  <tr> 
            ...
            <td  valign="top"><font size="2" face="Arial, Helvetica, sans-serif">Courier/BR. 
              Code 
              <input name="cour_code" type="text" id="cour_code" size="15" value="<?php echo $myrow['couri_code'];?>">
              </font></td>
              <td  valign="top"><font size="2" face="Arial, Helvetica, sans-serif">Date 
              &amp; Time<br>
              <input name="date_time" type="text" id="date_time" size="20" value="<?php echo $myrow['cour_date'];?>">
              </font></td>
          </tr>
      ...
      <td width="350" valign="top" class="sdiv">
      
      <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#DFFECB" class="tablehide">
		  ...
		  <table width="70%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#DFFECB" class="tablehide1">
          <tr> 
            <td >Service Provider :  <select name="through" >
	...
	?>
         ...
         <tr> 
            <td colspan="2"  align="center"><font size="2" face="Arial, Helvetica, sans-serif">PCS</font></td>
            <td align="center"><font size="2" face="Arial, Helvetica, sans-serif">KGS</font></td>
            <td align="center">OTHERS</td>
            <td align="center" ><font size="2" face="Arial, Helvetica, sans-serif">GMS</font></td>
            <td align="center" "><font size="2" face="Arial, Helvetica, sans-serif">VAT</font></td>
            <td align="center" ><font size="2" face="Arial, Helvetica, sans-serif">CHARGE</font></td>
          </tr>
          <tr> 
            <td colspan="2"><font size="2" face="Arial, Helvetica, sans-serif"> 
              <input name="no_pics" type="text" id="no_pics" size="5" value="<?php echo $myrow['no_pics'];?>">
              </font></td>
            <td><font size="2" face="Arial, Helvetica, sans-serif"> 
              <input name="kgs" type="text" id="kgs" size="5" value="<?php echo $myrow['kgs'];?>">
              </font></td>
            <td><input name="others" type="text" size="5" value="<?php echo $myrow['others'];?>"></td>
            <td valign="middle"><font size="2" face="Arial, Helvetica, sans-serif"> 
              <input name="gms" type="text" id="gms" size="5" value="<?php echo $myrow['gms'];?>">
            </font></td>
            <td valign="middle"><font size="2" face="Arial, Helvetica, sans-serif"> 
              <input name="vat" type="text" id="vatss" size="5" value="<?php echo $myrow['vat'];?>">
            </font></td>
            <td valign="middle"><font size="2" face="Arial, Helvetica, sans-serif"> 
              <input name="charges" type="text" id="charges" size="5" value="<?php echo $myrow['charges'];?>">
            </font></td>
          </tr>
          </table>
          <table width="60%" border="1" bordercolor="#FFFFFF" bordercolordark="#DFFECB" class="tablehide">
          <tr> 
            <td colspan="5"><div style="width:450px;">&quot;The 
              ...
              the documents or goods described below for delevery&quot; </div></td>
          </tr>
              <tr> 
            <td colspan="3"><font size="2" face="Arial, Helvetica, sans-serif">Full 
              Description of contents. (No Cash allowed)<br>
              <textarea name="disc_conten" cols="38" rows="2" id="disc_conten"><?php echo $myrow['descri_cont'];?></textarea>
              </font></td>
              
               <td colspan="2"><font size="2" face="Arial, Helvetica, sans-serif"> 
              Status
              <input name="status" type="text" id="status" size="17" value="<?php echo $myrowsp['status'];?>"><br>
               Current Location
              <input name="clocation" type="text" id="clocation" size="17" value="<?php echo $myrowsp['cLocation'];?>">
              </font></td>
          </tr>
          <tr> 
  ...
  <table width="800" border="0" cellspacing="5" cellpadding="5" >
    ...
    <tr> 
      ...
      <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#DFFECB" class="tablehide1">
